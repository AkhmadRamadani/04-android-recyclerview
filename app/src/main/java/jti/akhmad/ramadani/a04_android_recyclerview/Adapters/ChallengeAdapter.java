package jti.akhmad.ramadani.a04_android_recyclerview.Adapters;
...
import jti.akhmad.ramadani.a04_android_recyclerview.R;
...
public class ChallengeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ChallengeAdapter(List<String> itemList) {
